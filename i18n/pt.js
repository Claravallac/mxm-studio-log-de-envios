/* Echoform — textos da interface em Português (pt).
   Cada idioma é um content script separado, carregado ANTES do content.js
   (ver manifest.base.json / build.js). Ele só registra o dicionário em
   globalThis.__ECHOFORM_I18N; quem usa é o t() em content.js.
   Para adicionar um idioma: copie este arquivo, troque o código, traduza
   os valores (NÃO renomeie as chaves) e registre o código em I18N_IDIOMAS
   no build.js e em IDIOMAS_DISPONIVEIS no content.js. */
(globalThis.__ECHOFORM_I18N = globalThis.__ECHOFORM_I18N || {}).pt = {
  ...
  verificandoAtualizacaoChrome: 'Pedindo ao Chrome pra checar a Web Store — se a versão já estiver publicada, ele baixa e aplica sozinho.',
