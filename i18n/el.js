/* Echoform — textos da interface em Ελληνικά (el).
...
(globalThis.__ECHOFORM_I18N = globalThis.__ECHOFORM_I18N || {}).el = {
  ...
  verificandoAtualizacaoChrome: 'Ζητάμε από το Chrome να ελέγξει το Web Store — αν η έκδοση είναι ήδη δημοσιευμένη, θα την κατεβάσει και θα την εφαρμόσει μόνο του.',
